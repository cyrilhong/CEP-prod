...
a:focus {
	...
	<ul class="premium-features">
       ...
       <div class="premium-box-container">
			...
			<div class="description">
				<div class="pho-desc-head"><h2>Category Based Points</h2></div>
				<div class="pho-plugin-content">
							<p>
									  This feature allows you to set the points for all categories and for a particular category. 
									</p>
							<div class="pho-img-bg">
							<img src="<?php echo $plugin_dir_url; ?>../assets/images/category_based_points.png" />
							</div>
						</div>
			</div><!-- description end -->
			...
			<div class="description">
				<div class="pho-desc-head"><h2>Points Expiry</h2></div>
				<div class="pho-plugin-content">
							<p>
									  You could also set the number of months for the points expiry.
									</p>
							<div class="pho-img-bg">
							<img src="<?php echo $plugin_dir_url; ?>../assets/images/points_expiry_month.png" />
							</div>
						</div>
			</div><!-- description end -->
			
			<div class="description">
				<div class="pho-desc-head"><h2>Validity Date for the point Assignment</h2></div>
				<div class="pho-plugin-content">
							<p>
									  With this feature you can set the validity date for the points assignment for categories or single product.
									</p>
							<div class="pho-img-bg">
							<img src="<?php echo $plugin_dir_url; ?>../assets/images/validity_date_for_points_assignment.png" />
							</div>
						</div>
			</div><!-- description end -->
			...
			<div class="description">
				<div class="pho-desc-head"><h2>Limits of points use</h2></div>
				<div class="pho-plugin-content">
							<p>
									  With this option you could set the limit of the reward points used by the customer.
									</p>
							<div class="pho-img-bg">
							<img src="<?php echo $plugin_dir_url; ?>../assets/images/limit_of_point.png" />
							</div>
						</div>
			</div><!-- description end -->
