<div>
    ...
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_comment_tab_priority"><?php _e('Set the Discussion Tab as the first opened Tab', 'woodiscuz'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_is_name_field_required"><?php _e('Is name field required?', 'woodiscuz'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_is_email_field_required"><?php _e('Is email field required? ', 'woodiscuz'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_reply_button_only_author_show"><?php _e("Keep comment threads private for product author and thread starter. <br/> This option will not allow users reply in other users' threads, however those will be readable for all.", 'woodiscuz'); ?> </label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_request_for_comment"><?php _e('Requesting for comment on purchased product', 'woodiscuz'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row"><label for="wpc_is_guest_can_vote"><?php _e('Allow guests to vote on comments', 'woodiscuz'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    <label for="wpc_simple_comment_date"><?php _e('Use WordPress Date/Time format', 'woodiscuz'); ?></label>
            ...
            <tr valign="top">
                <th scope="row" >
                    <label for="wpc_is_use_po_mo"><?php _e('Use Plugin .PO/.MO files', 'woodiscuz'); ?></label>
            ...
            <tr valign="top">
                <th scope="row" >
                    <label for="wpc_show_plugin_powered_by"><?php _e('Help Woodiscuz to grow allowing people to recognize which comment plugin you use', 'woodiscuz'); ?></label>
