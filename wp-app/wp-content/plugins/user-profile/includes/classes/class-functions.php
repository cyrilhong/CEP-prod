...
class User_profile_functions{
	...
	public function profile_navs(){
		...
		return apply_filters('user_profile_filter_profile_navs', array(

			'feed' => array(
				'title'	=> __('Feed', 'user-profile'),
			),
			'about' => array(
				'title'	=> __('About', 'user-profile'),
			),
			// 'posts' => array(
			// 	'title'	=> __('Posts', 'user-profile'),
			// ),
			'followers' => array(
    ...
    public function get_addons_data(){
        ...
        return apply_filters( 'user_profile_filter_addons_data', array(
