...
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_header', 10);
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_basic_info', 10);
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_contacts', 15);
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_works', 20);
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_educations', 25);
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_places', 30);
add_action('user_profile_action_user_profile_edit_main','user_profile_action_user_profile_edit_main_footer', 35);
