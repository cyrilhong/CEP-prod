...
$user_profile_pages = array(
    ...
    'page_nav' 	=> '<i class="icofont icofont-page"></i> ' . __( 'Pages', 'user-profile' ),
    'priority' => 10,
	'page_settings' => array(
...
$user_profile_options = array(
    ...
    'page_nav' 	=> '<i class="icofont icofont-page"></i> ' . __( 'Options', 'user-profile' ),
    'priority' => 15,
	'page_settings' => array(
...
$user_profile_addons = array(
	'page_nav' => '<i class="icofont icofont-addons"></i> ' . __( 'Addons', 'user-profile' ),
	'show_submit' => false,
	'page_settings' => array(),
	'priority' => 20,
);
...
$user_profile_help = array(
    ...
    'page_nav' 	=> '<i class="icofont icofont-safety"></i> ' . __( 'Help', 'user-profile' ),
    'priority' => 30,
    'show_submit' => false,
	'page_settings' => array(
