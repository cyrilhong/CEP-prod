...
<section class="basic-info">
	...
	<h2 class="section-title"><?php echo __('Basic Info', 'user-profile'); ?></h2>

	<p class="section-field">
      	<label for="first_name"><?php echo __('First name', 'user-profile'); ?></label>
            ...
            <label for="last_name" style="margin-left:30px;"><?php echo __('Last name', 'user-profile'); ?></label>
