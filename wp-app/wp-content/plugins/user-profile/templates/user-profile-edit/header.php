...
if( $edit_hidden == 'y' && wp_verify_nonce( $nonce, 'nonce_user_profile_edit' ) ) :
	...
	$update_user = $thisuser->update_user_data( array(
		...
		'description' 	=> isset( $_POST[ 'description' ] ) ? wp_kses( $_POST[ 'description' ], $allowed_html ) : '',
		'user_url' 		=> isset( $_POST[ 'user_url' ] ) ? sanitize_text_field( $_POST[ 'user_url' ] ) : '',

		'user_profile_contacts'  => isset( $_POST[ 'user_profile_contacts' ] ) ? stripslashes_deep( $_POST[ 'user_profile_contacts' ] ) : '',
		'user_profile_work' 	 => isset( $_POST[ 'user_profile_work' ] ) ? stripslashes_deep( $_POST[ 'user_profile_work' ] ) : '',
		'user_profile_education' => isset( $_POST[ 'user_profile_education' ] ) ? stripslashes_deep( $_POST[ 'user_profile_education' ] ) : '',
		'user_profile_places' 	 => isset( $_POST[ 'user_profile_places' ] ) ? stripslashes_deep( $_POST[ 'user_profile_places' ] ) : '',
