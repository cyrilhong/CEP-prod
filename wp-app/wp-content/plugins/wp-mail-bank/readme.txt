...
Tags: gmail smtp, smtp, mail, phpmailer, wp mail, wp mail smtp, wordpress smtp, wordpress smtp plugin, email, oauth, smtp email wordpress
...
SMTP Plugin that fixes WordPress emails. Supports PHPMailer, Gmail SMTP, OAuth 2.0, Mailgun and all SMTP servers. Reconfigures wp_mail() to work.

== Description ==

### WP Mail Bank: The #1 WordPress SMTP Plugin
