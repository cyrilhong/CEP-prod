				...
				<div class="pnt-new-tik-form-wrap">
					...
					<?php wp_nonce_field( 'phoen_ticket_system_function', 'phoen_ticket_system_nonce_field' ); ?>
						...
						<div class="form-group">
						  ...
						  <label for="usr"><?php _e( 'Name', 'support-ticket-system-by-phoeniixx' ); ?></label>
						...
						<div class="form-group">
						  ...
						  <label for="usr"><?php _e( 'Subject', 'support-ticket-system-by-phoeniixx' ); ?></label>
						  
						  <input type="text" class="form-control phoen_ticket_subject_data" id="usr" placeholder="<?php _e( 'Subject', 'support-ticket-system-by-phoeniixx' ); ?>" name="custome_subject_detail"/>
						
						</div>
						
						<div class="form-group">
						
						  <label for="priority"><?php _e( 'Priority', 'support-ticket-system-by-phoeniixx' ); ?></label>
						  
						  <select class="form-control phoen_ticket_priority_data" name="customer_priority_set">
								<option></option>
								<option><?php _e( 'Low', 'support-ticket-system-by-phoeniixx' ); ?></option>
								<option><?php _e( 'Normal', 'support-ticket-system-by-phoeniixx' ); ?></option>
								<option><?php _e( 'High', 'support-ticket-system-by-phoeniixx' ); ?></option>
								<option><?php _e( 'Urgent', 'support-ticket-system-by-phoeniixx' ); ?></option>
						  </select>
						
						</div>
						
						<label for="usr"><?php _e( 'Message', 'support-ticket-system-by-phoeniixx' ); ?></label>
						...
						<div class="form-group">
							...
							<input type="submit" name="customer_detail_submit" value="<?php _e( 'Submit', 'support-ticket-system-by-phoeniixx' ); ?>" class="phoen_ticket_submit">
