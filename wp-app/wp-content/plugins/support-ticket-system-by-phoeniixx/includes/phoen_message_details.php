		...
		if($current_user->roles[0] == 'administrator')
		{
			...
			<div class="pst-user-panel">
			   ...
			   <div class="pst-user-list">
					...
					<a href="<?php echo $available_url_op ; ?>"> <h3> <span class="glyphicon glyphicon-folder-open"></span><?php _e( 'Open Tickets', 'support-ticket-system-by-phoeniixx' ); ?>  <span class="ticket-number"><?php echo $phoen_ticket_count_opens; ?></span> </h3></a>
				
				</div>
				
			   <div class="pst-user-list">
			   
					<a href="<?php echo $available_url_cl ; ?>"> <h3> <span class="glyphicon glyphicon-ok"></span><?php _e( 'Closed Tickets', 'support-ticket-system-by-phoeniixx' ); ?>  <span class="ticket-number"><?php echo $phoen_ticket_closed_counts;?></span> </h3></a>
    ...
    <div class="row">
				   ...
				   <div class="pho-user-asign">
						...
						<div class="form-group">
							...
							<select class="form-control"  name="phoe_select_status">
								...
								<option <?php echo ($phoen_get_customer_periority == 'LOW')?'selected':'';?>><?php _e( 'Low', 'support-ticket-system-by-phoeniixx' ); ?></option>
								<option <?php echo ($phoen_get_customer_periority == 'Normal')?'selected':'';?> ><?php _e( 'Normal', 'support-ticket-system-by-phoeniixx' ); ?></option>
								<option <?php echo ($phoen_get_customer_periority == 'High')?'selected':'';?>><?php _e( 'High', 'support-ticket-system-by-phoeniixx' ); ?></option>
								<option <?php echo ($phoen_get_customer_periority == 'Urgent')?'selected':'';?>><?php _e( 'Urgent', 'support-ticket-system-by-phoeniixx' ); ?></option>
        ...
        <div class="ticket-user-profile"> 
			...
			<div class="pnt-ticket-detail">
				...
				<h5><?php _e( 'Priority', 'support-ticket-system-by-phoeniixx' ); ?> 
