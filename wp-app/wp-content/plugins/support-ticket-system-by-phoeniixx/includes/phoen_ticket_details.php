			...
			<div class="row">
				...
				<div class="pst-search-bar">
					...
					<form class="pst-navbar-form" role="search">
					  ...
					  <input type="search" placeholder="<?php _e( 'Search Here', 'support-ticket-system-by-phoeniixx' ); ?>" class="phoen_filter_messege"/>
				...
				<div class="col-lg-3 col-md-3 col-sm-3 pst-user-panel-wrap">
					...
					<div class="pst-user-panel">
						...
						<div class="pst-user-list">
							...
							<a href="<?php echo $available_url_op ; ?>"> <h3> <span class="glyphicon glyphicon-folder-open phoeni_pending_tickets"></span><?php _e( 'Open Tickets', 'support-ticket-system-by-phoeniixx' ); ?> <span class="ticket-number"><?php echo $phoen_ticket_count_opens; ?></span> </h3></a>
						...
						<div class="pst-user-list">
							...
							<a href="<?php echo $available_url_cl ; ?>"> <h3> <span class="glyphicon glyphicon-ok phoeni_closed_ticket"></span><?php _e( 'Closed Tickets', 'support-ticket-system-by-phoeniixx' ); ?> <span class="ticket-number"><?php echo $phoen_ticket_closed_counts; ?></span> </h3></a>
						...
						<div class="pnt-submit-new-ticket">
							...
							<a title="New Ticket" href="<?php echo $available_url_create ; ?>"><?php _e( 'Create New Ticket', 'support-ticket-system-by-phoeniixx' ); ?></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-3 pst-user-panel-wrap">
					...
					<div class="pst-user-panel">
						...
						<div class="pst-user-list">
							...
							<a href="<?php echo $available_url_op ; ?>"> <h3> <span class="glyphicon glyphicon-folder-open phoeni_pending_tickets"></span><?php _e( 'Open Tickets', 'support-ticket-system-by-phoeniixx' ); ?> <span class="ticket-number"><?php echo $phoen_ticket_count_open_customer; ?></span> </h3></a>
